...
export function CallToAction() {
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-900">
      ...
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="bg-gradient-to-br from-gray-900 via-gray-900 to-emerald-950 rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden border border-white/5 shadow-2xl"
        >
          ...
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-xl mx-auto mb-8 leading-relaxed font-medium">
              {t.cta.description}
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <Link
                href="/login"
                className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-white px-8 py-3.5 rounded-xl font-bold text-lg transition-all shadow-lg shadow-emerald-500/20 hover:-translate-y-1 active:translate-y-0"
              >
