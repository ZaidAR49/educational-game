...
export function NewGameFlow({ organizations }: NewGameFlowProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20" dir="rtl">
      ...
      <div className="text-center max-w-2xl mx-auto mt-8">
        ...
        <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">كيف تود إنشاء لعبتك؟</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
        ...
        <motion.button
          ...
          className="bg-white rounded-3xl p-6 border-2 border-gray-100 hover:border-emerald-500 hover:shadow-[0_20px_40px_-15px_rgba(16,185,129,0.2)] transition-all text-right group flex flex-col items-start text-right"
        >
          <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            <PenTool className="w-6 h-6" />
          </div>
          <h3 className="text-xl font-black text-gray-900 mb-2">بناء يدوي</h3>
        ...
        <motion.button
          ...
          className="bg-white rounded-3xl p-6 border-2 border-gray-100 hover:border-purple-500 hover:shadow-[0_20px_40px_-15px_rgba(168,85,247,0.2)] transition-all text-right group flex flex-col items-start relative overflow-hidden"
        >
          ...
          <h3 className="text-xl font-black text-gray-900 mb-2 relative z-10">بناء عبر موجه (Prompt)</h3>
        ...
        <motion.button
          ...
          className="bg-gradient-to-br from-emerald-500 to-teal-700 rounded-3xl p-6 border-2 border-transparent shadow-xl hover:shadow-[0_20px_40px_-15px_rgba(16,185,129,0.4)] transition-all text-right group flex flex-col items-start relative overflow-hidden"
        >
          ...
          <div className="w-12 h-12 bg-white/20 text-white backdrop-blur-sm rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform relative z-10">
            <Sparkles className="w-6 h-6" />
          </div>
          <h3 className="text-xl font-black text-white mb-2 relative z-10 flex items-center gap-2">
            بناء بالذكاء الاصطناعي
            <span className="bg-white text-emerald-700 text-[10px] px-2 py-1 rounded-full font-bold">جديد</span>
          </h3>
