      ...
      <div className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-4 space-y-3">
            ...
            />
            {errors.title && <p className="text-red-500 text-sm font-bold text-start">{errors.title}</p>}
          </div>
          <div className="space-y-3">
            <label className="text-sm font-bold text-gray-700 block text-center">{t.gameWizard.gameIcon}</label>
            <input 
              type="text" 
              name="icon"
              value={formData.icon}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            <label className="text-sm font-bold text-gray-700 block text-start">{t.gameWizard.gameSlug}</label>
        ...
        <div className="space-y-3">
          <label className="text-sm font-bold text-gray-700 block text-start">{t.gameWizard.gameDesc}</label>
          <textarea 
            name="description"
          ...
          />
          {errors.description && <p className="text-red-500 text-sm font-bold text-start">{errors.description}</p>}
        </div>
      </div>
    </motion.div>
  )
