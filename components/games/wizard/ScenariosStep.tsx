  ...
  return (
    ...
    >
            ...
            {scenarios.map((scenario, index) => {
              ...
              return (
                <div 
                  ...
                  className={`p-3 rounded-xl cursor-pointer transition-all border-2 flex items-center gap-4 group
                    ${activeScenarioId === scenario.id 
                      ? 'border-emerald-500 bg-emerald-50 shadow-sm' 
                      : hasError ? 'border-red-300 bg-red-50' : 'border-transparent bg-gray-50 hover:bg-gray-100 hover:border-gray-200'
                    }`}
                >
                  <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center shadow-sm text-xl shrink-0">
                    {scenario.icon || "❓"}
                  </div>
      ...
      <div className="lg:col-span-8">
        {activeScenario && (
          <div className="bg-white rounded-[1.5rem] p-5 md:p-6 border border-gray-100 shadow-sm space-y-6">
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                        <div className="flex items-center gap-3 flex-1">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center border shrink-0 text-lg ${
