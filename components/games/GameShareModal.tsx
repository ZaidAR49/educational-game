          ...
          <div className="flex flex-col items-center w-full my-auto">
            {!isQrFullscreen && (
              <div className="mb-6 shrink-0 mt-2">
                <h3 className="text-2xl font-black text-gray-900 mb-2">{t.gameShare.title}</h3>
                <p className="text-gray-500">{t.gameShare.subtitle.replace('{title}', game.title)}</p>
              </div>
            )}
            ...
            <h2 className={`font-black text-emerald-600 shrink-0 mt-6 md:mt-8 ${isQrFullscreen ? 'text-4xl md:text-5xl' : 'text-xl'}`}>
              {t.gameShare.scanPrompt}
            </h2>

            {!isQrFullscreen && (
              <>
                <div className="w-full space-y-2 mt-6 shrink-0">
                  <label className="text-sm font-bold text-gray-500 block text-start">{t.gameShare.directLinkLabel}</label>
                  <div className="flex rounded-xl overflow-hidden border-2 border-gray-100 bg-gray-50">
                    ...
                    <button 
                      onClick={() => {
                        ...
                        toast.success(t.gameShare.copiedToast);
                      }}
                ...
                {hideLiveSessionButton ? (
                  ...
                  >
                    ...
                    <div className="relative flex h-3 w-3 rtl:mr-2 ltr:ml-2">
