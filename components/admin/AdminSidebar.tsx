...
import { Users, LayoutDashboard, Settings, LogOut, Gamepad2 } from "lucide-react"
...
export function AdminSidebar({ user }: AdminSidebarProps) {
  ...
  return (
    <aside className="w-64 bg-slate-900 text-white flex-col hidden md:flex fixed h-full right-0 z-20">
