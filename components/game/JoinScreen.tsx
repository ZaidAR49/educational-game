      ...
      <div className="mb-6 text-start">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute rtl:left-2 ltr:right-2 top-1/2 -translate-y-1/2 p-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-600 rounded-lg transition-colors group"
            title={t.game.join.randomNameTooltip}
          >
            <span className="text-xl group-hover:rotate-180 inline-block transition-transform duration-300">
              🎲
            </span>
          </button>
        </div>
