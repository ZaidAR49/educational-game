...
export default function LoginPage() {
  ...
  const termsParts = t.login.termsNotice.split("{termsLink}")
      ...
      >
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white p-8">
          <div className="text-center mb-8">
            <Link
              href="/"
              className="w-20 h-20 mx-auto mb-4 flex items-center justify-center hover:opacity-80 transition-opacity"
            >
              <Image
                src={AppLogo}
                alt="Logo"
