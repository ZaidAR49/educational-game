      ...
      <div className="flex-1 pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12">
          ...
          <div className="prose prose-emerald max-w-none text-gray-600 space-y-8 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">5. الاشتراكات، الحصص، والاستخدام العادل (Subscriptions & Quotas)</h2>
              <p>
                توفر المنصة باقات مجانية ومدفوعة (Pro). يخضع استخدام ميزات الذكاء الاصطناعي لحصص محددة (مثل عدد الطلبات والرموز المستخدمة) والتي تتجدد دورياً بناءً على خطة اشتراكك. 
                المنصة تحتفظ بالحق في تقييد الوصول مؤقتاً في حال تجاوز حصة الاستخدام العادل لمنع إساءة استخدام موارد الذكاء الاصطناعي.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">6. شروط الاستخدام وإدارة الحسابات</h2>
              <p>
                بصفتك معلماً أو صانع محتوى، أنت مسؤول بالكامل عن المحتوى والأسئلة والتلميحات التي تنشئها وتشاركها مع الطلاب عبر المنصة. يُمنع منعاً باتاً إنشاء أو مشاركة أي محتوى غير لائق، مسيء، مخرب، أو ينتهك حقوق الملكية الفكرية.
              </p>
              <p className="mt-2 text-red-600 font-medium">
                تحتفظ إدارة المنصة بالحق الكامل في مراقبة الاستخدام، وتعليق (حظر) أو حذف أي حساب ينتهك هذه الشروط أو يحاول التحايل على أنظمة الحصص والاشتراكات دون إشعار مسبق.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">7. التعديلات على الشروط والسياسات</h2>
              <p>
